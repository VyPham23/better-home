    ...
    <div>
      <Container fluid>
        <Row>
          <Card className="bg-dark text-white">
            ...
            <Card.ImgOverlay>
              <Card.Title><h5 className='lastest'>Contact Us</h5></Card.Title>
      ...
      <Row className='mt-5'></Row>
        <Row>
          <Col xs='1'></Col>
        <Col xs='5'>
          <Card className='shadow  bg-gray rounded' style={{ width: '90%'}}>
            ...
            <Card.Body>
              <Row className='mt-3'></Row>
                ...
                <p> https://play.google.com/store/apps</p>
                <p>https://www.kakaocorp.com/page/servicn</p>  
            </Card.Body>
          </Card>
          </Col>  {/* end col */}
